<?php 
SESSION_START();
if($_SESSION['Permissao'] != "professor")
{
	include('logout.php');
}
?>
...
<head>
    ...
    <title>EneSec - Página do professor</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background-color: #FFFFFF">
			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						<td> <?php echo $_SESSION["Identificador"]; ?> </td>
					</tr>
					<tr>
	...
	<ul class="list-inline banner-social-buttons text-center">
		<!-- <li>
			<button type="submit" class="btn btn-warning" onclick="editar()">Solicitar documentos</button>
		</li> -->
		<li>
	...
	<script>		
		/*function solicitar() {
			window.location.replace("solicitar-documentos-professor.html");
		}*/
