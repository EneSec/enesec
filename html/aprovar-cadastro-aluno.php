<?php
  ...
  $listaSQL = "SELECT * FROM `alunos_pendentes` ORDER BY `id`";
...
<html lang="en">
  ...
  <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background-color: #FFFFFF">
    ...
    <h1 class="text-info text-center"> Cadastro de alunos </h1>

    <div class="container" style="color: #000000">
      <table id="aluno" class="table table-hover" style="color: #000000">
        <thead id="header">
          <tr class="info">
            <th> Nome </th>
            <th> RG </th>
          ...
          <?php 
            ...
            if($rs->num_rows > 0) {
              while($row = $rs->fetch_assoc()) {
                ...
                echo "<td id='fileira'>" .$row['identidade'] ."</td>";
    ...
    <script>
      ...
      function confirmar(id) {
        var redirect = 'cadastrar-aluno.php?id=' + id + '&value=1'  ;
        window.location.href = redirect;
      }

      function rejeitar(id) {
        var redirect = 'cadastrar-aluno.php?id=' + id + '&value=0'  ;
